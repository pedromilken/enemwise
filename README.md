...
- **Resolução comentada** após cada resposta e nas revisões. Gerada uma vez no pipeline com `enemwise resolucoes` (API da Anthropic, cache retomável em `out/resolucoes.json`) e levada ao app pelo `merge`.
